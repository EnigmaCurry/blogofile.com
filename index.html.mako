...
<div class="blog_post">
  <span class="post_prose">
    ...
    Assuming you already have <a href="http://www.python.org">Python</a> and Setuptools installed (<small>on ubuntu "sudo apt-get install python-setuptools"</small>), just run:
